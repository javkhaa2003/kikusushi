...
function filter_smilies(s) {
	for (var i = 0; i < smilies.length; i++) {
		...
		var imgsrc = 'http://ichurchoka.com/wp-includes/images/smilies/' + smilies[i][1];
...
var GetChaturl  = 'http://ichurchoka.com/wp-content/plugins/simple-ajax-chat/simple-ajax-chat-core.php?sacGetChat=yes';
var SendChaturl = 'http://ichurchoka.com/wp-content/plugins/simple-ajax-chat/simple-ajax-chat-core.php?sacSendChat=yes';
...
function receiveChatText() {
	...
	if (httpReceiveChat.readyState == 4 || httpReceiveChat.readyState == 0) {
		...
		var nonce = '&sac_nonce_receive=cc9082e481';
...
function insertNewContent(liName,liText,lastResponse, liUrl, liId) {
	...
	insertO.insertBefore(oLi, insertO.firstChild);
		...
		jQuery.post('http://ichurchoka.com/wp-content/plugins/simple-ajax-chat/includes/sac-check-user.php', 'sac_user=' + encodeURIComponent(liName), function(response){
...
function checkName() {
	...
	if (chat_name != sacCookie) {
		document.cookie = 'sacUserName=' + chat_name + '; expires=Thu, 19 Oct 2017 18:46:31 UTC;';
	}
...
function checkUrl() {
	...
	if (currentName.value != sacCookie) {
		document.cookie = 'sacUrl=' + currentName.value + '; expires=Thu, 19 Oct 2017 18:46:31 UTC;';
		return;
	}
...
jQuery(document).ready(function($){
	...
	var url = 'http://ichurchoka.com/wp-content/plugins/simple-ajax-chat/resources/nonce.php';
